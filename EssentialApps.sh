...
while true; do
  ...
  case $opcao in
    ...
    echo "====================================================================
    Selecione o Tema desejado para instalação
    ...
    if [ $NUM -eq 1 ]
    then
      # Instalação do Paper Thema
      # tema de ícones e GTK "Paper", ele vai deixar o seu sistema com o padrão visual do Android Lollypop.
      # Para quem gosta de personalizar o sistema aqui vai uma boa pedida, o tema Paper se inspira no Material Design do Google, usado
      # em todos os produtos da empresa hoje em dia praticamente, com linhas suaves para o tema GTK do sistema.
    ...
    39)
    echo "====================================================================
    Selecione o pacote de icons desejado para instalação
    ...
    if [ $NUM -eq 1 ]
    then
      # Instalação do pack de icons Numix
    ...
    then
      #  ícones Moka para Ubuntu e Linux Mint.
    ...
    40)
    echo "====================================================================
    Selecione o Dockin desejado para instalação
